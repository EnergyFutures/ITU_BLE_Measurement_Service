...
#define BOOTLOADER_BUTTON_PIN           30                                              			  /**< Button used to enter SW update mode. */
...
{   
    nrf_gpio_cfg_sense_input(BOOTLOADER_BUTTON_PIN, NRF_GPIO_PIN_PULLUP, NRF_GPIO_PIN_SENSE_LOW);
...
int main(void)
{
    ...
    dfu_start = app_reset;
    dfu_start |= nrf_gpio_pin_read(BOOTLOADER_BUTTON_PIN) == 0;
