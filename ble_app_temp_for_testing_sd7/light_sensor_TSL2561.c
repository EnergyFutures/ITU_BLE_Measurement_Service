...
#define light_sens_adr TSL2561_ADDR_FLOAT
#define TSL2561_BASE_PIN 19
...
static itu_sensor_t light_sensor1 ={.sensor_timer_init = sensor_timer_init,
																		...
																		.needs_adc = false,
																		.adc_done = NULL,
																		.type = BLE_UUID_ITU_SENSOR_TYPE_LIGHT,
																		.make = BLE_UUID_ITU_SENSOR_MAKE_TSL2561};

itu_sensor_t * getLightSensorTSL2561(void){
